...
type ModuleSourceWithClientOpts = {
    /**
...
declare class ModuleConfigClient extends BaseClient {
     ...
     * Constructor is used for internal usage only, do not create object from it.
     */
    constructor(ctx?: Context, _id?: ModuleConfigClientID, _dev?: boolean, _directory?: string, _generator?: string);
    /**
...
declare class ModuleSource extends BaseClient {
     ...
     */
    withClient: (generator: string, outputDir: string, opts?: ModuleSourceWithClientOpts) => ModuleSource;
    /**
