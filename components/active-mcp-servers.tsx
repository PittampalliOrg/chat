          ...
          return (
            <Tooltip key={serverId}>
              <TooltipTrigger asChild>
                ...
                >
                  <div className="size-2 rounded-full bg-green-500 mr-1.5 shrink-0" />
                  <ServerIcon className="size-3 mr-1 shrink-0" />
                  ...
                  >
                    <XCircleIcon className="size-3.5 text-green-700/70 dark:text-green-400/70 hover:text-red-500 dark:hover:text-red-400" />
                  </button>
                </Badge>
              </TooltipTrigger>
              <TooltipContent>
